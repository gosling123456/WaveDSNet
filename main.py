...
from models.DWT import WaveDSNet2
...
def train_args():
    ...
    parser.add_argument("--dataset", type=str, default="S1GFloods")
    ...
    parser.add_argument("--ablation", type=str, default='WaveDSNet')
...
def train(opt):
    ...
    for epoch in range(start_epoch, opt.epochs):
        ...
        print()
    test_for_metric(model, test_loader, criterion, input_size=opt.input_size, dual_label=opt.dual_label, save_path=f"{opt.resume}/test")


        
if __name__ == '__main__':
    opt = train_args()
    opt.dataset_dir = f"../../data/Work1-data/{opt.dataset}"
    ...
    # python main.py --dataset VarFloods-P --batch_size 16 --learning-rate 1e-3 --epochs 100 --resume CHECKPOINT
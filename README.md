...
This project proposes WveDSNet, an end-to-end water change detection network in SAR imagery and achieves state-of-the-art performance on the newly constructed large-scale benchmark dataset **XDU-SWCD**.
